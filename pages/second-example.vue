        ...
        <v-stepper v-model="e6" vertical>
          ...
          <v-stepper-content step="4">
            <div class="intervals_wrap">
              <v-row no-gutters>
                ...
                <v-col>
                  <v-card-text class="" style="display: flex; justify-content: center; font-size: 30px; padding: unset;">
              ...
              <v-col style="margin: unset; padding: unset;">
                <img src="/intervals2.svg" width="100%" alt="image description">
              </v-col>
              <v-row no-gutters>
                <v-col>
                  <v-card-text style="display: flex; justify-content: flex-end; font-size: 30px; padding: unset; text-align: center">
                    0
                  </v-card-text>
                </v-col>
                <v-col>
                ...
                <v-col>
                  <v-card-text class="" style="display: flex; justify-content: flex-start; font-size: 30px; padding: unset; text-align: center">
                    4
                  </v-card-text>
                </v-col>
              </v-row>
          ...
          <v-stepper-content step="5">
            <div style="display: flex; justify-content: space-between;">
              <h3 style="align-items: center; justify-content: center; margin: 1rem; flex-direction: column;">
                <katex-expression
                  expression= 'y^{\prime} = \frac{1}{9}\left( x\left(x - 4\right)^3\right)^{\prime} = '
                  katex-options='{ "displayMode": true , "throwOnError": true }'>
                </katex-expression>
              </h3>
            ...
            <div class="intervals_wrap">
              <v-row no-gutters>
                ...
                <v-col>
                  <v-card-text class="" style="display: flex; justify-content: center; font-size: 30px; padding: unset;">
                    <v-btn fab small style="margin-right: 5%; font-size: 30px;" @click="ascendingDescending2 = !ascendingDescending2">
                      {{ btnTextDerivative1 }}
                    </v-btn>
                  </v-card-text>
                </v-col>
                <v-col>
                  <v-card-text style="display: flex; justify-content: center; font-size: 30px; padding: unset;">
                    <v-btn fab small class="" style="font-size: 30px;" @click="ascendingDescending3 = !ascendingDescending3">
                      {{ btnTextDerivative2 }}
                    </v-btn>
                  </v-card-text>
                </v-col>
          ...
          <v-stepper-content step="6">
            <div style="display: flex; justify-content: space-between;">
              <h3 style="align-items: center; justify-content: center; margin: 1rem; flex-direction: column;">
                <katex-expression
                  expression= 'y^{\prime\prime} = \left(\frac{(x - 4)^2}{9}(4x - 4)\right)^{\prime} = '
                  katex-options='{ "displayMode": true , "throwOnError": true }'>
                </katex-expression>
              </h3>
            ...
            <div class="intervals_wrap">
              <v-row no-gutters>
                ...
                <v-col>
                  <v-card-text class="" style="display: flex; justify-content: center; font-size: 30px; padding: unset;">
                    <v-btn fab small style="margin-right: 5%; font-size: 30px;" @click="convex2 = !convex2">
                      {{ btnTextConvex2 }}
                    </v-btn>
                  </v-card-text>
                </v-col>
                <v-col>
                  <v-card-text style="display: flex; justify-content: center; font-size: 30px; padding: unset;">
                    <v-btn fab small class="" style="font-size: 30px;" @click="convex3 = !convex3">
                      {{ btnTextConvex3 }}
                    </v-btn>
                  </v-card-text>
                </v-col>
  ...
  export default {
    ...
    computed: {
      btnText() {
        ...
        if (this.plusMinus && !this.plusMinus2 && this.plusMinus3) {
          this.success4 = false
        } else {
          this.success4 = true
        }
      ...
      btnTextDerivative() {
        ...
        if (!this.ascendingDescending1 && this.ascendingDescending2 && this.ascendingDescending3) {
      ...
      btnTextConvex1() {
        ...
        if (this.convex1 && !this.convex2 && this.convex3) {
          if (this.convexFlag) {
            this.success6 = false
          }
        } else {
    ...
    methods: {
      ...
      rangeInputHandler() {
        ...
        if (range !== 'x∈R' && range !== 'x∈(-∞;+∞)' && range !== 'R' && range !== '(-∞;+∞)') {
          this.success1 = true
          return 'Ответ неверный'
        } else {
          this.success1 = false
      ...
      forDerivative() {
        ...
        if (expression !== '0' && expression !== '((x-4)^2)/9(4x-4)') {
          this.success5 = true
          return 'Ответ неверный'
        } else {
      ...
      forNullHandler1() {
        if ((this.funcNum1 === '0') || (this.funcNum1 === '4')) {
          if (this.funcNum1 === '0') {
      ...
      forNullHandler2() {
        if ((this.funcNum2 === '0') || (this.funcNum2 === '4')) {
          if (this.funcNum2 === '0') {
            if (this.funcNumCount1 === true) {
              return 'нули не должны совпадать'
            } else {
