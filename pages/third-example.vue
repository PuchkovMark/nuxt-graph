        ...
        <v-stepper v-model="e6" vertical>
          ...
          <v-stepper-content step="5">
            <div style="display: flex; justify-content: space-between;">
              <h3 style="align-items: center; justify-content: center; margin: 1rem; flex-direction: column;">
                <katex-expression
                  expression= 'y^{\prime} = (x^3 - 6x^2 + 9x -4)^{\prime} = '
                  katex-options='{ "displayMode": true , "throwOnError": true }'>
                </katex-expression>
              </h3>
          ...
          <v-stepper-content step="6">
            <div style="display: flex; justify-content: space-between;">
              <h3 style="align-items: center; justify-content: center; margin: 1rem; flex-direction: column;">
                <katex-expression
                  expression= 'y^{\prime\prime} = (3x^2 - 12x + 9)^{\prime} = '
                  katex-options='{ "displayMode": true , "throwOnError": true }'>
                </katex-expression>
              </h3>
  ...
  export default {
    ...
    methods: {
      ...
      forConvex() {
        ...
        if (expression !== '6x-12' && expression !== '0') {
          this.success6 = true
          return 'Ответ неверный'
        } else {
      ...
      forNullHandler1() {
        if ((this.funcNum1 === '1') || (this.funcNum1 === '4')) {
          if (this.funcNum1 === '1') {
      ...
      forNullHandler2() {
        if ((this.funcNum2 === '1') || (this.funcNum2 === '4')) {
          if (this.funcNum2 === '1') {
            if (this.funcNumCount1 === true) {
              return 'нули не должны совпадать'
            } else {
